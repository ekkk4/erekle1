    ...
    <section className="relative min-h-screen flex items-start justify-center overflow-hidden pt-32 md:pt-40">
      ...
      <div className="relative z-10 container mx-auto px-6 text-left md:max-w-[50%] md:mr-auto md:ml-12 lg:ml-20">
        ...
        <motion.h1
          ...
          className="font-display text-6xl md:text-8xl lg:text-9xl leading-none mb-6 drop-shadow-[0_4px_30px_rgba(0,0,0,0.8)]"
        >
          EREKLE
          <br />
          <span className="text-gradient drop-shadow-[0_2px_20px_rgba(0,0,0,0.5)]">BAGASHVILI</span>
        </motion.h1>
